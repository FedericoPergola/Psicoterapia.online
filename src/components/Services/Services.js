            ...
            <Modal
                ...
                closeModal={closeSecondModal}>
                    <div className='modal-text modal-scroll'>
                        ...
                        <p className='description-modal p-0'>La Arte terapia es una profesión con más de setenta años de historia que se encuadra dentro de las profesiones asistenciales. La Arte terapia se práctica siguiendo una metodología bajo un marco terapéutico definido. En este caso: la psicología transpersonal, confluye junto al arte en un proceso holístico destinado a re crearnos mediante la explotación.
                        ...
                        Sin ser necesarias grandes habilidades o conocimientos plásticos, la obra es siempre valiosa porque nace de la autenticidad del creador. No es un espacio para aprender técnicas plásticas, aquí lo estético no tiene valor. Es un espacio terapéutico, el foco esta puesto en que cada creación es la expresión interior de nuestro ser, aportándonos información, permitiéndonos reencontrarnos. Si queres conocer en mayor profundidad este espacio agenda tu primera sesión para experimentarlo.</p>
                        <ul>
            ...
            <Modal
                ...
                closeModal={closeThirdModal}>
                    ...
                    <div className='modal-text'>
                        ...
                        <p className='description-modal'>Brindamos talleres grupales de diversas tematicas orientadas a la salud para cualquier persona interesada en el desarrollo personal.
                            Si sos profesional de la salud, o estudiante tambien contamos con una oferta de formacion que se ve renovando año a año.
                            Para enterarte de las novedades podes dejarnos tu correo contandonos si te interesan los talleres o formaciones y te contactaremos compartiendote las novedades.
                        </p>
                    </div>
            </Modal>
        </>
