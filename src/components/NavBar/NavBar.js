...
const NavBar = () => {
  return (
    <nav class="navbar navbar-expand-lg bg-body-tertiary flex-column p-0">
                ...
                <div class="offcanvas-body justify-content-end">
                    <ul class="navbar-nav justify-content-end pe-3">
                        <li class="nav-item mx-3">
                            <a class="nav-link nav-text" aria-current="page" href="#">Sobre nosotros</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link nav-text" href="#">Equipo</a>
                        </li>
                        <li class="nav-item mx-3">
                            <a class="nav-link nav-text" href="#">Servicios</a>
                        </li>
                        <li class="nav-item mx-3">
